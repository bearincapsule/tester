...
def test_keyboard():
    ...
    def on_press(key):
        ...
        # Check for the combination of Shift + Q
        if {"Q"}.issubset(pressed_keys):
            print("Shift + Q pressed, exiting...")
            return False
    ...
    print("Press Shift + Q to exit the keyboard test...")
